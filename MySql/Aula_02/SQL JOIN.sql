...
SELECT *FROM tb_produtos WHERE preco BETWEEN 5 AND 15 ORDER BY preco; -- Mostra os dados ordenado pelo preço
...
SELECT * FROM tb_produto WHERE nome LIKE "%ra%";
...
-- Produto mais caro da quitanda
SELECT max(preco) FROM tb_produtos;
-- Produto mais barato da quitanda
SELECT min(preco) FROM tb_produtos;

-- Faça a junção da tabela produtos e da tabela categoria
...
UPDATE tb_produtos SET categorias_id = 6 WHERE id = 16;
